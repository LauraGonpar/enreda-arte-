...
const Checkout = () => {
  ...
  const handlePagar = async (e) => {
    ...
    Swal.fire({
      title: "Procesando tu joya...",
      text: "Validando pago y actualizando inventario EnredaArte",
    ...
    try {
      ...
      console.error("Detalle del error en EnredaArte:", error);
      Swal.fire("Error", "Hubo un problema con la transacción.", "error");
    } finally {
  ...
  return (
    <div className="container-fluid bg-enredarte-cream pt-5 mt-5 min-vh-100 px-lg-5">
      <div className="container py-4">
        <h2 className="text-enredarte-red fw-bold mb-2">
          Confirmación de compra
        </h2>
        <div className="d-flex align-items-center mb-5 small">
          <span className="text-muted">Dirección</span>
          <div
            className="mx-2 border-bottom border-enredarte-red opacity-25"
            style={{ width: "40px" }}
          ></div>
        ...
        <div className="row g-5">
          <div className="col-md-7">
            <div className="d-flex gap-2 mb-4">
              <button
                type="button"
                className="btn btn-light border border-dark rounded-0 px-4 py-2"
              >
                <i className="bi bi-paypal text-primary me-2"></i> PayPal
              </button>
              <button
                type="button"
                className="btn btn-brown text-white rounded-0 px-4 py-2"
              >
                Credit Card
              </button>
            </div>
            ...
            <form onSubmit={handlePagar}>
              <div className="mb-3">
                <input
                  type="text"
                  className="form-control rounded-0 border-dark bg-transparent py-2"
              ...
              <div className="row g-2 mb-3">
                <div className="col-4">
                  <select
                    className="form-select rounded-0 border-dark bg-transparent py-2"
                    required
                  >
              ...
              <div className="form-check form-switch d-flex justify-content-between align-items-center p-0 mb-4">
                <label className="form-check-label small text-enredarte-red">
                  Guardar datos para futuros pagos
                </label>
                <input
                  className="form-check-input ms-0 border-dark"
                  type="checkbox"
                  role="switch"
                />
              </div>
              ...
              <button
                ...
                className="btn btn-brown w-100 py-3 fw-bold rounded-0 text-white shadow-sm"
              >
                {isProcessing
                  ? "Procesando..."
          ...
          <div className="col-md-5">
            ...
            <div className="pe-md-4">
              {cart.map((item) => (
                <div
                  key={item.id}
                  className="d-flex align-items-center mb-4 border-bottom border-dark border-opacity-25 pb-3"
                >
                  <div
                    className="bg-white p-1 rounded shadow-sm me-3"
                    style={{ width: "85px", height: "85px" }}
                  >
                    <img
                      src={
                        item.imagen ||
                        imagenesMapa[item.id] ||
                  ...
                  <div className="flex-grow-1">
                    <h6 className="fw-bold mb-1 text-enredarte-red">
                      {item.nombre}
                    </h6>
                    ...
                    <p className="fw-bold mb-0">
                      $
                      {(
                        Number(item.precio || 0) * Number(item.count || 1)
              ...
              <div className="d-flex justify-content-between fw-bold fs-5 mt-4">
                <span>Total:</span>
                <span className="text-enredarte-red">
